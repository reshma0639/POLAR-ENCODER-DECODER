...
#include<string.h>
#include<stdio.h>
int Q1[8] = {0,1,2,4,3,5,6,7};/*, 8, 16, 32, 3, 5, 64, 9, 6, 17, 10, 18, 128, 12, 33, 65, 20, 256, 34, 24, 36, 7, 129, 66, 512, 11, 40, 68, 130,
...
void setup() 
{
a1 = (int *)malloc(8 * sizeof(int));
b1 = (int *)malloc(8 * sizeof(int));
for(i=0;i<N-K;i++)
{
  F[i]=Q1[i];
}
